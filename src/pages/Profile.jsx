...
const Profile = () => (
  <>
    <MetaTags 
      ...
      keywords="フロントエンド,エンジニア,React,JavaScript"
    />
    <section id="profile" className="section">
      ...
      <h2 className="section-title">
        ...
        <div className="pr-content">
          ...
          <div className="pr-item">
            <h3>【エンジニア事例】非効率な作業手順の改善提案</h3>
            <p>
            配属先にて、手順化された定型作業に1時間以上を要していた。
    Sakuraエディタなどの外部ツール使用が禁止され、Microsoft製品のみ使用可という制約の中、<br />
    VBAによって業務を約10分に簡略化する手法を構築し提案。<br />
    </p>

    <p>
    仕様・手順に準拠したものであったが、現場の運用方針と合わず、提案は却下。<br />
    その後、記録として残した内容が一部で参考にされる形となった。
            </p>
          </div>
        </div>
    </section>
